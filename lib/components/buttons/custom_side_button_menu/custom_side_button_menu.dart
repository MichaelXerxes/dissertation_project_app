...
import 'package:dissertation_project_app/components/containers/animated_item_container/animated_item_container_side_menu.dart';
...
class _CustomSideButtonMenuState extends State<CustomSideButtonMenu>
  ...
  Widget animatedAlign(int minDuration, int maxDuration, IconData icon,
      Alignment alignment, Function onTap) {
    return AnimatedAlign(
      ...
      child: GestureDetector(
        onTap: () {
          // Handle tap (e.g., navigation or action)
          onTap(); // Call the function passed as a parameter
        },
        child: AnimatedContainer(
          ...
          width: size1,
          decoration: BoxDecoration(
              color: Colors.black87, borderRadius: BorderRadius.circular(40.0)),
          child: Icon(
            icon,
            color: Colors.white,
          ),
